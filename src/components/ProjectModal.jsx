        ...
        <div className="overflow-y-auto flex-1">
          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center text-accent-gold font-medium mb-6">
              ...
              {project.description && (
                <p className="text-base md:text-lg text-text-secondary leading-relaxed border-l-2 border-accent-gold/40 pl-4">
                  {project.description}
                </p>
              )}
            </div>
