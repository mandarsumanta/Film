...
const ShowreelSection = () => {
  ...
  const PORTFOLIO_URL = '/files/sumanta-mandar-portfolio.pdf';

  // Showreel data
  const showreelData = {
    title: "DIRECTOR'S SHOWREEL",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", // Demo showreel - replace with actual
    duration: "2:30",
  ...
  const handleDownloadResume = () => {
    // Open resume PDF in a new tab (served from public/files)
    window.open(RESUME_URL, '_blank', 'noopener,noreferrer');
  };

  const handleViewPortfolio = () => {
    // Open portfolio PDF in a new tab (served from public/files)
