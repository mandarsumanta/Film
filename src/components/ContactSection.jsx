...
const ContactSection = () => {
  ...
  const getIconForPlatform = (iconName) => {
    const icons = {
      ...
      instagram: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.316-1.296C4.165 14.824 3.675 13.673 3.675 12.376s.49-2.448 1.458-3.316c.868-.806 2.019-1.296 3.316-1.296s2.448.49 3.316 1.296c.968.868 1.458 2.019 1.458 3.316s-.49 2.448-1.458 3.316c-.868.806-2.019 1.296-3.316 1.296zm7.072 0c-1.297 0-2.448-.49-3.316-1.296-.968-.868-1.458-2.019-1.458-3.316s.49-2.448 1.458-3.316c.868-.806 2.019-1.296 3.316-1.296s2.448.49 3.316 1.296c.968.868 1.458 2.019 1.458 3.316s-.49 2.448-1.458 3.316c-.868.806-2.019 1.296-3.316 1.296z"/>
        </svg>
      ),
      vimeo: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
