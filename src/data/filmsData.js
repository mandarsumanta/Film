...
export const filmsData = [
  ...
  {
    id: 36,
    title: "Dhukur Kamila ra Shikari",
    year: 2017,
    genre: "Animation",
    duration: "1 min",
    category: "music-video",
...
export const getCategoryDisplayName = (categoryId) => {
  ...
  return categoryMap[categoryId] || categoryId.replace('-', ' ');
};
...
export const categories = [
  ...
  { id: 'music-video', name: 'Animation', count: filmsData.filter(p => p.category === 'music-video').length }
];
...
export const roles = [
  ...
  'Animator', // Changed from 'Animation' to match project data
  'Photography'
];

// Role synonyms mapping for flexible filtering
export const roleSynonyms = {
  'director of photography': ['cinematographer', 'dop', 'director of photography'],
  'cinematographer': ['cinematographer', 'director of photography', 'dop'],
